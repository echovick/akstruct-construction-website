...
new #[Layout('layout.admin')] class extends Component {
    ...
    // Features
    public $features = [['title' => '', 'description' => '', 'icon' => '']];
    ...
    public function save()
    {
        ...
        $service->detailed_description = $this->detailed_description;
        ...
        if ($this->featured_image) {
            $service->featured_image = $this->featured_image->store('services', 'public');
        }
